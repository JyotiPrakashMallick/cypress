/* AUTO-575 This code links the online appointment request with an appointment have partial match
...
it('Case 1 - update first name and link partial match request to an appointment',function(){
...
it('Case 2 - update first name and phone number and link partial match request to an appointment',function(){
    cy.log('Raise an online appointment request')
    let onlineBookingData
    cy.fixture('api/patientmanagement/partialMatchOnlineBook').then((obData)=>{
        onlineBookingData=obData
...
it('Case 3 - update last name and phone number and link partial match request to an appointment',function(){
    cy.log('Raise an online appointment request')
    let onlineBookingData
    cy.fixture('api/patientmanagement/partialMatchOnlineBook').then((obData)=>{
        onlineBookingData=obData
...
it('Case 4 - update birth date and phone number and link partial match request to an appointment',function(){
    cy.log('Raise an online appointment request')
    let onlineBookingData
    cy.fixture('api/patientmanagement/partialMatchOnlineBook').then((obData)=>{
        onlineBookingData=obData
